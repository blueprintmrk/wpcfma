...
// this for find the internal image you specified.
// when change host, you must change it for website to run
//if(! defined('LOCAL_FILE_BASE_DIRECTORY') )	define ('LOCAL_FILE_BASE_DIRECTORY', '/home/mbogestion.com/');	
...
class timthumb {
	...
	protected function getLocalImagePath($src){
     ...
     //   $absolute = '/home/mbogestion.com/'. $src;//realpath('/' . $src);
       //  $absolute = realpath(basename(getenv("SCRIPT_NAME")));
