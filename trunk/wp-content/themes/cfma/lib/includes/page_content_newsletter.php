<?php
    ...
    //newslwtterclasses('body',$_classesemail);
    //print_r($_classesemail);
	// the_content();
?>
<?php ?>
<?php // newslwtterclasses('newl_body',$_classesemail); ?>

<div <?php newslwtterclasses('newl_body',$_classesemail); ?>>

<table width="100%" cellspacing="0" cellpadding="0" <?php newslwtterclasses('newl_body',$_classesemail); ?>><tbody><tr><td align="center" valign="top">          
...
<table width="600" cellspacing="0" cellpadding="0" style="font-size:14px;color:#ffffff;line-height:150%;font-family:Arial;width:600px;background-color:#000000;padding:0px;text-align: justify;vertical-align: top;table-layout: auto;"><tbody>
     ...
     <tr class="header">
        ...
        <td style="text-align:left; width: 186px;min-height: 100px;vertical-align: top;">
            <img style="margin:0;padding:0;width: 186px;" alt="" src="http://local.cfma/wp-content/uploads/2012/03/cfma_logo_mini.png"/>
        </td>
...
<!--////////////////////////////////-->
        <div style="padding-left:20px;padding-right:20px;width: 560px;">
                <p style="margin: 5px 0; padding: 0;color:#c8b27b;font-size:18px;font-weight:normal;font-style:normal;font-family:Arial">EDITO</p>
        </div>
        <div style="padding-left:20px;padding-right:20px;width: 560px;text-align: justify;">
            <p style="margin: 0; padding: 0;"> Sous-traitance / Co-traitance une nuance que la CFMA se propose de porter auprès des grands groupes de Luxes et des TPE et PME de métiers d’art afin que leur relations soient en adéquation avec la volonté des pouvoirs publiques pour le “fait en France “.</p>
        </div>
        ...
        <div style="padding-left:20px;padding-right:20px;width: 560px;">
            ...
            <div style="float: left;margin:0;padding:0;margin-right:10px;width: 150px; min-height:  90px;">
                <img border="0" style="float: left;margin:0;padding:0;width: 150px;" alt="" src="http://local.cfma/wp-content/uploads/2012/03/cfma_logo_mini.png"/>
            </div>
...
Face à la mondialisation et à la prolifération des contrefaçons sur internet, le dépôt communautaire présente donc un intérêt certain. Il permet, au moins sur le territoire européen, de mieux protéger ses droits de propriété intellectuelle lorsque ceux-ci sont contrefaits sur internet.</p>
            ...
            <div style="float: left;margin:0;padding:0;width: 150px; min-height:  90px;">
                <img border="0" style="float: left;margin:0;padding:0;width: 150px;" alt="" src="http://local.cfma/wp-content/uploads/2012/03/justice-logo-pro_00FA000000313681.jpg"/> 
            </div>
            <div style="clear: both; height: 1px;">&nbsp;</div> 
        </div>
        <div style="padding:0px; width: 350px; height: 12px;margin-top:0px;margin-bottom:10px; border-bottom: 1px solid #c8b27b;">&nbsp;</div>
